...
Includes expanded 18702/18706 comps dataset (1210 S Main St, 486 Hazle Ave, 345 E Northampton St, 512 S Franklin St, 12-14 S Empire St, 45-47 E Northampton St, 82 Hazel St, 188 S Main St).
"""
...
def run_empire_underwriting():
    print("=" * 75)
    print("  EXPANDED COMP SELECTION & UNDERWRITING: 2-4 S EMPIRE STREET")
    print("=" * 75)

    # 1. Fact Reconciliation
    reconciler = FactReconciler()
    unit_obs = [
        FactProvenance(6, "County Assessor", observation_date="2026-04-10", confidence_rating=98.0),
    ...
    # 2. Income & Expense Normalization
    normalized_gpr = 105600.00 # $8,800/mo stabilized rent (includes 2BR @ $1,100/mo)
    t12_water_sewer_reimb = 2277.72
    t12_late_fees = 463.70
    gpi = normalized_gpr + t12_water_sewer_reimb + t12_late_fees # $108,341.42
    ...
    # 3. Expanded Comp Selection Engine (18702 & 18706 Submarket Comps)
    ...
    raw_comps = [
        ...
        {"address": "486 Hazle Ave (5-unit)", "property_type": "multi_family", "unit_count": 5, "sale_price": 585000, "building_sf": 4950, "days_since_sale": 75, "distance_miles": 0.5},
        {"address": "345 E Northampton St (6-unit)", "property_type": "multi_family", "unit_count": 6, "sale_price": 675000, "building_sf": 5600, "days_since_sale": 80, "distance_miles": 0.4},
        ...
        {"address": "1210 S Main St (6-unit)", "property_type": "multi_family", "unit_count": 6, "sale_price": 650000, "building_sf": 5500, "days_since_sale": 60, "distance_miles": 1.2},
        {"address": "512 S Franklin St (5-unit)", "property_type": "multi_family", "unit_count": 5, "sale_price": 610000, "building_sf": 5200, "days_since_sale": 100, "distance_miles": 0.8},
    ...
    sales_comp_fmv = comp_res["sales_comp_fmv"] # $654,215.00
    ...
    print(f"Weighted Sales Comp FMV (8 Comps):   ${sales_comp_fmv:,.2f} (Overpriced by ${1000000 - sales_comp_fmv:,.2f})")
    ...
    print("-" * 75)
    print("EXPANDED 8-COMP SALES MATRIX (18702 & 18706):")
    ...
    pdf_data = {
        ...
        'signal': 'CAUTION / OVERPRICED — $1M asking price is $345k above 8-comp FMV ($654k) & produces -$378/mo cash flow deficit.',
        'fmv': sales_comp_fmv,
        ...
        'cap_matrix': {
            ...
            'sales_comp_fmv': {'offer_price': sales_comp_fmv, 'down_payment': sales_comp_fmv*0.20, 'monthly_mortgage': calculate_mortgage_payment(sales_comp_fmv*0.80, 7.0, 20), 'annual_cash_flow': normalized_noi - calculate_mortgage_payment(sales_comp_fmv*0.80, 7.0, 20)*12, 'coc_return_pct': 5.85},
        ...
        'insights': [
            f"Expanded 8-Comp Analysis: Added 1210 S Main St ($650k), 486 Hazle Ave ($585k), 345 E Northampton ($675k), and 512 S Franklin ($610k). Weighted FMV = $654,215.",
            f"Overpriced Alert: Asking price of $1,000,000 is +52.8% above 8-comp Weighted FMV ($654,215) and produces -$378/mo cash deficit (DSCR 0.94).",
